...
import { StyleSheet, Text, View, SafeAreaView, Image, TextInput, KeyboardAvoidingView, TouchableOpacity, Platform} from 'react-native';
  ...
  return (
      <SafeAreaView style={styles.container}>
          ...
          <View styles={styles.bottom}>
              <TouchableOpacity
                  onPress={() => isBusiness ? signUpBusiness(username, password, confirmPassword, email) : signUpUser(username, password, confirmPassword, email)}
              >
