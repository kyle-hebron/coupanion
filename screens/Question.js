...
import { StyleSheet, Text, View, SafeAreaView, Image, ScrollView, TouchableOpacity, Animated, } from 'react-native';
...
render () {
    ...
    return (
      ...
      <View style={{flex: 1}}>
      <FadeInView>
        <Text style={{fontSize: 45, textAlign: 'center', margin: 10,fontWeight: 'bold'}}>Welcome to Coupanion</Text>
      </FadeInView>
    </View>
      ...
      <View style={styles.innerContainer}>
        ...
        <View style={[styles.balloon, {backgroundColor: '#FFFFFF'}]}>
